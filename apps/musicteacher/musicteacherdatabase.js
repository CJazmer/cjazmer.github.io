...
const LatinGenres = [
    ...
    {name: "Salsa", description: `1) Piano (tumbao or montuno rhythm) <br> 2) Timbales (Cascara hit sides of timbal) (Cascara on cowbell to add energy) have footpedal with clave/cowbel to add more percussion <br> 3) Bass (tumbao, rushed feel) <br> 4) Congas (tumbao) <br> 5) Metal Guira/Shaker (16th Notes Constant flow, can add triplet shake on 1st note *no chachacha) <br> 6) Brass (can do on piano) <br> *The piano is the hardest part to get right (You can play bass and piano riff at the same time!) <br> *Hitting metal sound (cascara on cowbell) and horns gives salsa its sound <br><br> <iframe style="border-radius:12px" src="https://open.spotify.com/embed/playlist/0hgnsVpwIMrhljhaj3xGby?utm_source=generator" width="100%" height="352" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>`},
    {name: "Merengue", 
    ...
    {name: "Bolero", description: `Slow paced straight beat, has a roll on 2nd beat (B r r - B - B -) *r is roll <br> 1) Guitar/Tres/Piano Chords <br> 2) Shaker/Guira (constant 8th notes (roll on 2 & 3 beat) <br> 3) Bass (B - - - B - B -) <br> 4) congas & bongo <br><br> <iframe style="border-radius:12px" src="https://open.spotify.com/embed/playlist/2uBIys5nViQv3et2qPPBAL?utm_source=generator" width="100%" height="352" frameBorder="0" allowfullscreen="" allow="autoplay; clipboard-write; encrypted-media; fullscreen; picture-in-picture" loading="lazy"></iframe>`},
    {name: "Guajira", 
