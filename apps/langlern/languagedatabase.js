...
const vAnimals = [
  ...
  const vFood = [
    {english: "food", spanish: "la comida", german: "das Essen", swedish: "en mat"},
    {english: "water", spanish: "el agua", german: "das Wasser", swedish: "ett vatten"},
    {english: "drink", spanish: "la bebida", german: "das Getränk", swedish: "en drink"},
    {english: "beer", spanish: "cerveza", german: "das Bier", swedish: "en öl"},
    {english: "ice", spanish: "el hielo", german: "das Eis", swedish: "en is"},
    {english: "bread", spanish: "pan", german: "das Brot", swedish: "en bröd"},
    {english: "rice", spanish: "arroz", german: "der Reis", swedish: "ett ris"},
    {english: "meat", spanish: "la carne", german: "das Fleisch", swedish: "ett kött"},
    {english: "onion", spanish: "cebolla", german: "die Zwiebel", swedish: "en lök"},
    {english: "cheese", spanish: "queso", german: "der Käse", swedish: "en ost"},
    {english: "peppers", spanish: "pimientos", german: "der Pfeffer", swedish: "peppar"},
    {english: "sandwich", spanish: "sandwich", german: "das Sandwich", swedish: "en smörgås"},
    {english: "salt", spanish: "sal", german: "das Salz", swedish: "ett salt"},
  ];
  const vLandscape = [
  ...
  const vWorld = [
    {english: "people", spanish: "gente", german: "die Leute", swedish: "ett folk"},
    {english: "country", spanish: "país", german: "das Land", swedish: "ett land"},
    {english: "flag", spanish: "bandera", german: "die Flagge", swedish: "en flagga"},
    {english: "city", spanish: "ciudad", german: "die Stadt", swedish: "en stad"},
    {english: "building", spanish: "edificio", german: "das Gebäude", swedish: "en byggnad"},
    {english: "neighborhood", spanish: "barrio", german: "die Nachbarschaft", swedish: "ett grannskap"},
    {english: "street", spanish: "calle", german: "die Straße", swedish: "en gata"},
    {english: "car", spanish: "carro", german: "das Auto", swedish: "en bil"},
    {english: "boat", spanish: "bote", german: "das Boot", swedish: "en båt"},
    {english: "plane", spanish: "avión", german: "das Flugzeug", swedish: "ett flygplan"},
    {english: "sidewalk", spanish: "banqueta", german: "der Gehweg", swedish: "en trottoar"},
    {english: "yard", spanish: "patio", german: "das Yard", swedish: "..."},
  ];
  const vBody = [
    {english: "body", spanish: "cuerpo", german: "der Körper", swedish: "en kropp"},
    {english: "head", spanish: "la cabeza", german: "der Kopf", swedish: "ett huvud"},
    {english: "face", spanish: "la cara", german: "das Gesicht", swedish: "ett ansikte"},
    {english: "eye", spanish: "el ojo", german: "das Auge", swedish: "ett öga"},
    {english: "mouth", spanish: "la boca", german: "der Mund", swedish: "en mun"},
    {english: "nose", spanish: "la naris", german: "die Nase", swedish: "en näsa"},
    {english: "ear", spanish: "la oreja", german: "das Ohr", swedish: "ett öra"},
    {english: "beard", spanish: "la barba", german: "der Bart", swedish: "en skägg"},
    {english: "hair", spanish: "el pelo", german: "die Haare", swedish: "ett hår"},
    {english: "arm", spanish: "el brazo", german: "der Arm", swedish: "en arm"},
    {english: "hand", spanish: "la mano", german: "die Hand", swedish: "en hand"},
    {english: "hand & arm", spanish: "...", german: "...", swedish: "..."},
    {english: "leg", spanish: "la pierna", german: "das Bein", swedish: "ett ben"},
    {english: "foot", spanish: "el pie", german: "der Fuß", swedish: "en fot"},
  ]
  const vCloths = [
    {english: "cap", spanish: "la gorra", portugese: "", german: "die Kappe", swedish: "en hatt"},
    {english: "glasses", spanish: "gafas/lentes", portugese: "", german: "die Brille", swedish: "glasögon"},
    {english: "cloths", spanish: "la ropa", portugese: "roupa", german: "die Kleidung", swedish: "en kläder"},
    {english: "shirt", spanish: "la camiseta", portugese: "camisa", german: "das Hemd", swedish: "en skjorta"},
    {english: "pants", spanish: "pantalones", portugese: "calça", german: "die Hose", swedish: "en byxa"},
    {english: "socks", spanish: "los calcetines", portugese: "", german: "die Socken", swedish: "strumpor"},
    {english: "shoe", spanish: "el zapato", portugese: "sapato", german: "der Schuh", swedish: "en sko"},
    {english: "necklace", spanish: "el collar", german: "die Halskette", swedish: "ett halsband"},
  ];
  const vTime = [
    {english: "today", spanish: "hoy", german: "heute", swedish: "idag"},
    {english: "tomorrow", spanish: "mañana", german: "morgen", swedish: "imorgon"},
    {english: "yesterday", spanish: "ayer", german: "gestern", swedish: "igår"},
    {english: "now", spanish: "ahora", german: "jetzt", swedish: "nu"},
    {english: "later", spanish: "más tarde", german: "später", swedish: "senare"},
    {english: "again", spanish: "otra vez", german: "wieder", swedish: "igen"},

    {english: "second", spanish: "segundo", german: "der Zweite", swedish: "en sekund"},
    {english: "minute", spanish: "minuto", german: "die Minute", swedish: "en minut"},
    {english: "hour", spanish: "hora", german: "die Stunde", swedish: "en timme"},
    {english: "day", spanish: "día", german: "der Tag", swedish: "en dag"},
    {english: "night", spanish: "noche", german: "die Nacht", swedish: "en natt"},
    {english: "week", spanish: "semana", german: "die Woche", swedish: "en vecka"},
    {english: "month", spanish: "mes", german: "der Monat", swedish: "en månad"},
    {english: "year", spanish: "año", german: "das Jahr", swedish: "ett år"},

    {english: "spring", spanish: "primavera", german: "der Frühling", swedish: "en vår"},
    {english: "summer", spanish: "verano", german: "der Sommer", swedish: "en sommar"},
    {english: "fall", spanish: "otoño", german: "der Herbst", swedish: "en höst"},
    {english: "winter", spanish: "invierno", german: "der Winter", swedish: "en vinter"},
  ];
  ...
  const vLanguage = [
    {english: "language", spanish: "el idioma", german: "die Sprache", swedish: "ett språk"},
    {english: "word", spanish: "la palabra", german: "das Wort", swedish: "ett ord"},
    {english: "sentence", spanish: "la frase", german: "der Satz", swedish: "en mening"},
    {english: "spanish", spanish: "español", german: "Spanisch", swedish: "spanska"},
    {english: "english", spanish: "inglés", german: "Englisch", swedish: "engelsk"},
    {english: "russian", spanish: "ruso", german: "Russisch", swedish: "ryska"},
    {english: "german", spanish: "alemán", german: "Deutsch", swedish: "tyska"},
    {english: "arabic", spanish: "árabe", german: "Arabisch", swedish: "arabiska"},
  ];
  const vFamily = [
    {english: "dad", spanish: "padre", german: "der Papa", swedish: "en pappa"},
    {english: "mom", spanish: "madre", german: "die Mama", swedish: "en mamma"},
    {english: "sister", spanish: "hermana", german: "die Schwester", swedish: "en syster"},
    {english: "brother", spanish: "hermano", german: "der Bruder", swedish: "en bror"},
    {english: "grandpa", spanish: "abuelo", german: "der Opa", swedish: "en farfar"},
    {english: "grandma", spanish: "abuela", german: "die Oma", swedish: "en mormor"},
    {english: "man", spanish: "hombre", german: "der Mann", swedish: "en man"},
    {english: "woman", spanish: "mujer", german: "die Frau", swedish: "en kvinna"},
    {english: "kid", spanish: "niño", german: "das Kind", swedish: "ett barn"},
  ];
  const vMain = [
    {english: "there is/are", spanish: "hay", german: "...", swedish: "...", russian: "есть"},
    {english: "this/that is", spanish: "...", german: "das", swedish: "...", russian: "это"},
    {english: "hi", spanish: "hola", german: "hallo", swedish: "hej"},
    {english: "yes", spanish: "sí", german: "ja", swedish: "ja"},
    {english: "no", spanish: "no", german: "nein", swedish: "nej"},
    {english: "and", spanish: "y", german: "und", swedish: "och"},
    {english: "thanks", spanish: "gracias", german: "danke", swedish: "tack"},
    {english: "please", spanish: "por favor", german: "bitte", swedish: "snälla"},
    {english: "here", spanish: "aquí", german: "hier", swedish: "här"},
    {english: "there", spanish: "alla", german: "dort", swedish: "där"},

    {english: "what", spanish: "qué", german: "was", swedish: "vad"},
    {english: "where", spanish: "dónde", german: "wo", swedish: "var"},
    {english: "why", spanish: "por qué", german: "warum", swedish: "varför"},
    {english: "who", spanish: "quién", german: "wer", swedish: "vem"},
    {english: "when", spanish: "cuando", german: "wenn", swedish: "när"},
    {english: "how", spanish: "cómo", german: "wie", swedish: "hur"},

    {english: "with", spanish: "con", german: "mit", swedish: "med"},
    {english: "without", spanish: "sin", german: "ohne", swedish: "utan"},
    {english: "food", spanish: "comida", german: "das Essen", swedish: "en mat"},
    {english: "water", spanish: "agua", german: "das Wasser", swedish: "ett vatten"},
    {english: "money", spanish: "dinero", german: "das Geld", swedish: "en pengar"},
    {english: "house", spanish: "casa", german: "das Haus", swedish: "ett hus"},
    {english: "phone", spanish: "celular", german: "das Telefon", swedish: "en telefon"},
    {english: "job", spanish: "trabajo", german: "die Arbeit", swedish: "ett jobb"},
  ];
  const vPronouns = [
    {english: "I", spanish: "yo", german: "ich", swedish: "jag"},
    {english: "you", spanish: "tú", german: "du", swedish: "du"},
    {english: "you formal", spanish: "usted", german: "sie", swedish: "..."},
    {english: "he", spanish: "él", german: "er", swedish: "han"},
    {english: "she", spanish: "ella", german: "sie", swedish: "hon"},
    {english: "it", spanish: "lo/la", german: "es", swedish: "det"},
    {english: "we", spanish: "nosotros", german: "wir", swedish: "ci"},
    {english: "yall", spanish: "...", german: "ihr", swedish: "..."},
    {english: "they", spanish: "ellos", german: "sie", swedish: "de"},
    {english: "my", spanish: "mi", german: "mein", swedish: "min/mitt"},
    {english: "your", spanish: "tu", german: "dein", swedish: "din/ditt"},
    {english: "his", spanish: "...", german: "sein", swedish: "hans"},
    {english: "her", spanish: "...", german: "ihr", swedish: "hennes"},
    {english: "its", spanish: "...", german: "sein", swedish: "dess"},
    {english: "his/her/it", spanish: "su", german: "...", swedish: "..."},
    {english: "our", spanish: "nuestro", german: "unser", swedish: "vår/vårt"},
    {english: "yall's", spanish: "...", german: "euer", swedish: "..."},
    {english: "their", spanish: "su", german: "ihr", swedish: "deras"},
  ];
  const veeee = [
  ...
  const vVerbs1 = [
    {english: "want", spanish: "querer (quier)", german: "wollen (will)", swedish: "vilija (vill)"},
    {english: "need, have to", spanish: "necesitar", german: "müssen", swedish: "måste"},
    {english: "eat", spanish: "comer", german: "essen", swedish: "äta"},
    {english: "drink", spanish: "tomar |take|", german: "trinken", swedish: "dricka (dricker)"},
    {english: "know", spanish: "saber", german: "wissen (weiß)", swedish: "veta (vet)"},
    {english: "think", spanish: "pensar (piens)", german: "denken", swedish: "tänka (tänker)"},
    {english: "remember", spanish: "recordar (recuer)", german: "denken", swedish: "minna (minns)"},
    {english: "do, make", spanish: "hacer", german: "machen", swedish: "göra (gör)"},
    {english: "give", spanish: "dar", german: "geben", swedish: "ge (ger)"},
    {english: "take", spanish: "...", german: "nehmen", swedish: "ta (tar)"},
    {english: "live", spanish: "vivir", german: "leben", swedish: "leva (lever)"},
    {english: "live (reside)", spanish: "vivir", german: "leben", swedish: "bo (bor)"},
    {english: "say/tell", spanish: "decir", german: "sagen", swedish: "säga (säger)"},
    {english: "speak", spanish: "hablar", german: "sprechen", swedish: "tala (talar)"},
    {english: "use", spanish: "usar", german: "benutzen", swedish: "använda (använder)"},
    {english: "learn", spanish: "aprender", german: "lernen", swedish: "lära (lär sig)"},
    {english: "practice", spanish: "praticar", german: "üben", swedish: "träna (tränar)"},
    {english: "work", spanish: "trabajar", german: "arbeiten", swedish: "jobbar"},
    {english: "have", spanish: "tener (tien)", german: "haben", swedish: "ha (har)"},
    {english: "help", spanish: "ayudar", german: "helfen", swedish: "hjälpa (hjälper)"},
    {english: "like", spanish: "gustar", german: "mögen", swedish: "gilla (gillar)"},
    {english: "hear", spanish: "escuchar", german: "hören", swedish: "höra (hör)"},
    {english: "able to", spanish: "poder (pon)", german: "können", swedish: "kan"},
    {english: "see", spanish: "ver", german: "sehen", swedish: "ser"},
    {english: "buy", spanish: "comprar", german: "kaufen", swedish: "köpa (köper)"},
    {english: "sell", spanish: "vender", german: "verkaufen", swedish: "sälja (säljer)"},
  ];
  const vVerbs2 = [
