...
const vAnimals = [
  ...
  const vFamily = [
    ...
    {english: "man", spanish: "hombre", german: "der Mann", swedish: "en man", russian: "мужчина", arabic: "رَجُل"},
    {english: "woman", spanish: "mujer", german: "die Frau", swedish: "en kvinna", russian: "женщина", arabic: "اِمْرأة"},
