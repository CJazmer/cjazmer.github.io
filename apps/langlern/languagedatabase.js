...
const languagedatabase = [
    ...
    {name: `haitian`, langfam: `Romance / Bantu`, colors:clrsarr[5], lessonsobjs: null, examples: arabicExamples, audioindex: 0},
...
const vAnimals = [
  ...
  const vRoom = [
    ...
    {english: "kitchen", spanish: "la cocina", german: "die Küche", swedish: "ett kök", russian: "кухня", arabic: "مَطْبَخ", tags: "extra"},
  ...
  const vFamily = [
    {english: "family", spanish: "la familia", german: "", swedish: "", russian: ""},
    ...
    {english: "brother", spanish: "el hermano", german: "der Bruder", swedish: "en bror", russian: "брат"},
  ...
  const vVerbs1 = [
    ...
    {english: "to need, have to", spanish: "necesitar", german: "müssen", swedish: "måste", russian: "", hawaiian: "pono", haitian: "oblije"},
    ...
    {english: "to take", spanish: "...", german: "nehmen", swedish: "ta (tar)", russian: "", arabic: "أَخَذَ"},
    ...
    {english: "to try", spanish: "intentar", german: "", swedish: "", russian: "", arabic: ""},
  ...
  const vVerbs3 = [ // modify somthing
    ...
    {english: "to win", spanish: "ganar", tags: "extra"},
    {english: "to lose", spanish: "pedir", tags: "extra"},
